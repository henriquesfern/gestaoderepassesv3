...
export const adaptFomento2026 = (
  ...
  return {
    ...
    gestao_primeirorepasse: gestaoRow?.primeirorepasse !== undefined ? String(gestaoRow.primeirorepasse) : undefined,
    gestao_dataprimeirorepasse: gestaoRow?.dataprimeirorepasse,
    gestao_segundorepasse: gestaoRow?.segundorepasse !== undefined ? String(gestaoRow.segundorepasse) : undefined,
