export const CITIES_COORDS = [
  ...
  { name: 'BALNEARIO CAMBORIA', label: 'Balneário Camboriú', lat: -26.9834, lng: -48.6338 },
  ...
  { name: 'CORNALIO PROCOPIO', label: 'Cornélio Procópio', lat: -23.1779, lng: -50.6477 },
  ...
  { name: 'MARALIA', label: 'Marília', lat: -22.2128, lng: -49.9456 },
